...
func (c *Container) initDependencies() {
	...
	c.oauthHandler = handlers.NewOAuthHandler(c.authService)
	...
	//wishlist
	c.wishlistRepo = repository.NewWishlistRepository(c.db)
	...
	//product_discount
	c.productDiscountRepo = repository.NewProductDiscountRepository(c.db)
...
func (c *Container) TrackingRepo() repository.TrackingRepository { return c.trackingRepo }
